// 此列表控件支持多行列表头
#ifndef __DUI_LIST_H__
#define __DUI_LIST_H__
...
#define UILIST_MAX_COLUMNS 32  // 列表空件支持的最大列数
...
public:
	...
	virtual bool IsMultiSelectItem()const = 0;
};
...
public:
	...
	virtual bool IsMultiSelectItem()const{ return false;}
...
public:
    ...
    void SetScrollPos( SIZE szPos );
	void SetScrollPos( SIZE szPos, bool bFloatScroll );
	void SetPos( RECT rc );
	void SetPos( RECT rc, bool  bFloatScroll );
    void DoEvent( TEventUI& event );
...
public:
	...
	void SetPaintText(bool bPaintText);
    void DoEvent( TEventUI& event );
    SIZE EstimateSize( SIZE szAvailable );
...
protected:
    ...
    UINT m_uButtonState;
    IListOwnerUI* m_pOwner;
	CStdString m_strHotBkImage;
	CStdString m_strSelectedBkImage;
};
